...
float LightIntensityM = 0.6;//メインライトの全体の強さ。1で減少無し。
float TIntensityM = 1.0;//トップライトの強さ。1.0で強さの変化なし。
float MIntensityM = 0.3;//ミドルライトの強さ。1.0で強さの変化なし。
...
float LightIntensityA = 0.6;//照り返し環境光の全体の強さ。1で減少無し。
