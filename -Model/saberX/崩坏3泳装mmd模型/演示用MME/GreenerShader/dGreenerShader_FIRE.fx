...
/////////////////////////////
//メインライトパラメーター
float3 TColorM = {1.00,0.60,0.20};//トップライトの色。//すべて1で白。すべて0で黒。
float3 MColorM = {1.00,0.25,0.25};//ミドルライトの色。//色の明るさが強さに影響するので注意。
float3 UColorM = {1.00,0.25,0.25};//ボトムライトの色。
...
float3 MColorA = {0.5,0.2,0.2};//ミドルライトの色。//色の明るさが強さに影響するので注意。
float3 UColorA = {0.5,0.3,0.2};//ボトムライトの色。
