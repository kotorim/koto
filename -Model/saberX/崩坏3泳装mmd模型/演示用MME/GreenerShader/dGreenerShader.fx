...
/////////////////////////////
//メインライトパラメーター
float3 TColorM = {1.00,0.90,0.80};//トップライトの色。//すべて1で白。すべて0で黒。
float3 MColorM = {0.35,0.35,1.00};//ミドルライトの色。//色の明るさが強さに影響するので注意。
float3 UColorM = {1.00,0.60,0.60};//ボトムライトの色。
...
/////////////////////////////
//照り返し環境光パラメーター
float3 TColorA = {0.7,0.8,1.0};//トップライトの色。//すべて1で白。すべて0で黒。
float3 MColorA = {0.5,0.5,0.7};//ミドルライトの色。//色の明るさが強さに影響するので注意。
float3 UColorA = {1.0,0.3,0.2};//ボトムライトの色。
